    ...
    children: [
      {
        ...
        loadChildren: () =>
          import(
            '../../pages/calculation-loan-page/calculation-loan-page.module'
          ).then((module) => module.CalculationLoanPageModule),
      },
    ],
  },
  {
    path: 'main/processing',
    component: ProcessingPageComponent,
    children: [
      {
        path: '',
        loadChildren: () =>
          import('../../pages/processing-page/processing-page.module').then(
    ...
    children: [
      {
        ...
        loadChildren: () =>
          import(
            '../../pages/documents-payments-page/documents-payments-page.module'
