...
eOSAGOCostBody = {
 ...
 public сalculateEosagoCost(): Observable<any> {
  ...
  const url = environment.apiUrl + '/calculateKbm?user=5043c2bd04614726ab79a1c08a7fcd7cce3d445d5af44e54be7e5499d0ba826f';
...
public createEosago(): Observable<any> {
  ...
  const url = environment.apiUrl + '/createKbm?request_id=9cb0dd4916d7410b8b96c9ae5f074b9843ed681b26ff4fd090951f9c3102a74e&user=5043c2bd04614726ab79a1c08a7fcd7cce3d445d5af44e54be7e5499d0ba826f';
...
public checkPolicyCalculationStatus(): Observable<any> {
  ...
  const url = environment.apiUrl + '/checkPolicyStatus?request_id=9cb0dd4916d7410b8b96c9ae5f074b9843ed681b26ff4fd090951f9c3102a74e';
...
public checkPolicyCreationStatus(): Observable<any> {
    ...
    const url = environment.apiUrl + '/checkPolicyCreationStatus?request_id=1ef3edf4335f46e99bea6446829fbdc990593a07942a434689e302c03303b95d';
...
//showAnketa
showAnketaBody = {
    policyCalculationId: "a2d10388e76a406d8669cee0e1c3e54321babd354f4e4b598f74bc8eaf7a14bc",
...
public CalculatePreliminaryCostCasko(): Observable<any> {
  ...
  const url = environment.apiUrl + '/calculateCasco?customer_id=f6329f12-85eb-46e5-b07e-1d41da8ae5d3';


  return this.http
  .post<any>(url, this.calculatePreliminaryCostCaskoBody, { headers: httpHeaders })
  .pipe(
    tap((response: any) => console.log(response))
  );
}
...
public startOfferCreationCasko(): Observable<any> {
  ...
  return this.http
  .post<any>(url, this.startCascoOfferCreationBody, { headers: httpHeaders })
  .pipe(
    tap((response: any) => console.log(response))
  );
}
...
public getFinalCaskoCalculation(): Observable<any> {
    ...
    const url = environment.apiUrl + '/getFinalCascoCalculation?policy_id=29616655';
...
public addCar(): Observable<any> {
  ...
  const url = environment.apiUrl + '/carInfo?owner_id=f6329f12-85eb-46e5-b07e-1d41da8ae5d3';
...
public updateCarInfo(): Observable<any> {
  ...
  const url = environment.apiUrl + '/carInfo?owner_id=f6329f12-85eb-46e5-b07e-1d41da8ae5d3&car_id=1';
...
public addDriver(): Observable<any> {
  ...
  const url = environment.apiUrl + '/driverInfo?customer_id=f6329f12-85eb-46e5-b07e-1d41da8ae5d3';
